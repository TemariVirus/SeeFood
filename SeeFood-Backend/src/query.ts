...
export class Query<T> {
    ...
    join<U extends Entity>(type: JoinType,
        ...
        if (table instanceof Query)
            this.clauses.push(new Clause.JoinClause(type, table.toString(), left_col, operator, right_col));
        else
            this.clauses.push(new Clause.JoinClause(type, table.tableName, left_col, operator, right_col));
